...
<table   height = 400px, width = 100%>
  <tr>
    <td width = 300px> <img src="pic1.jpg" alt="" height = 400px width = 300px></td>
    <td width = 300px><img src="down3.webp" alt="" height = 400px width = 300px></td>
    <td width =400px  > <img src="down1.webp" alt="" height = 400px width =290px ></td>
    <td width = 300px> <img src="down6.jpg" alt="" height = 400px  width = 300px></td>
  </tr>
</table>
    </div>
</body>
