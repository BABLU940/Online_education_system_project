...
<head>
    ...
    <title>Service Checkpoint</title>
...
<body  class="bg-light" bgcolor = "grey">
<div class='head'>
<img src="download.jpg" alt="" height = 100px>
  ...
  <main>
    <div class="py-5 text-center">
      <img class="d-block mx-auto mb-4" src="pic2.jpg" alt="" width="100px" height="50px">
      <h2>Service form</h2>
  ...
  <footer class="my-5 pt-5 text-muted text-center text-small">
    <p class="mb-1">&copy; 2021–2025 Online smart learning system</p>
